let productPlaceHolder = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3qlCiSzodCQ5eeHXtCy--aoXJCJHrMzkrwJpYYN2R3A&s"

export function cardProduct(product) {
  return `<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
    <a href="#">
    <img class="p-8 rounded-t-lg " src="${product?.thumbnail || productPlaceHolder}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
